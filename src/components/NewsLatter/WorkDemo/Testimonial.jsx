...
const Testimonial = () => {
  return (
    <div>
      <section className='text-neutral-700 dark:text-neutral-300 shadow-2xl my-20 rounded-lg'>
        ...
        <div className='grid gap-6 text-center md:grid-cols-3'>
          <div>
            <div className='block rounded-lg bg-white shadow-lg dark:bg-neutral-700 dark:shadow-black/30'>
              <div className='h-28 overflow-hidden rounded-t-lg bg-[#2f70cc]'></div>
          ...
          <div>
            <div className='block rounded-lg bg-white shadow-lg dark:bg-neutral-700 dark:shadow-black/30'>
              <div className='h-28 overflow-hidden rounded-t-lg bg-[#6f26ee]'></div>
              <div className='mx-auto -mt-12 w-24 overflow-hidden rounded-full border-2 border-white bg-white dark:border-neutral-800 dark:bg-neutral-800'>
          ...
          <div>
            <div className='block rounded-lg bg-white shadow-lg dark:bg-neutral-700 dark:shadow-black/30'>
              <div className='h-28 overflow-hidden rounded-t-lg bg-[#2e77fd]'></div>
              <div className='mx-auto -mt-12 w-24 overflow-hidden rounded-full border-2 border-white bg-white dark:border-neutral-800 dark:bg-neutral-800'>
